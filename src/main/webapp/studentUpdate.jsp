...
<body>
	...
	<div class="container">
		...
		<form id="passwordForm" class="form-group" name="StudUpdate"
			method="post" action="StudUpdate" onsubmit="return mail()">
			...
			<table class="table-responsive">
				...
				<tr>
					...
					<td><select class="form-control brc"
					...
					<td><input class="form-control brc" name="year"
						value="<%=student.getYear()%>" id="year" required></td>

					<td><input class="form-control brc" type="text"
						value="<%=student.getFathername()%>" name="fathername"
						id="fathername" placeholder="fathername" required></td>
					<td><input class="form-control brc" type="text"
					...
					<td><select class="form-control brc" type="text" name="batch"
						id="batch">
							<option value="<%=student.getBatch()%>"><%=student.getBatch()%>
							</option>

							<%
							List<BatchModel> blist = (List<BatchModel>) request.getAttribute("batchlist");

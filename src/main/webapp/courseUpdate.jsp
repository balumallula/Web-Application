...
<body>
	...
	<div class="container">
		<a href="CourseList"><button type="button" class="btn" id="b1">Back</button></a>
		<a href="./admin.jsp"><button type="button" class="btn" id="b2">Home</button></a>

		<h1>Update Course</h1>
		<form id="passwordForm" class="form-group" name="CourseUpdate"
			method="post" action="CourseUpdate" onsubmit="return mail()">

...
<body>
	...
	<div class="container">
		...
		<h1>Update Paymnet</h1>
		<form id="passwordForm" class="form-group" name="PaymentUpdate"
			method="post" action="PaymentUpdate" onsubmit="return mail()">
			...
			<table class="table-responsive">
				...
				<%
				List<PaymentModel> list = (List<PaymentModel>) session.getAttribute("paylist");

...
<body>
	...
	<div class="container">
		<a href="BatchList"><button type="button" class="btn" id="b1">Back</button></a>
		<a href="./admin.jsp"><button type="button" class="btn" id="b2">Home</button></a>

		<h1>Delete Batch</h1>
		<form id="passwordForm" class="form-group" name="BatchDelete"
			method="post" action="BatchDelete" onsubmit="return mail()">
			...
			<table class="table-responsive">
				...
				<tr>
					...
					<td><input class="form-control brc" type="date"
						value="<%=batch.getDate()%>" name="date" id="date" placeholder="" readonly></td>
					<td><input class="form-control brc" type="text" value="<%=batch.getCourse()%>" name="course"
						id="course" readonly>
					 </td>

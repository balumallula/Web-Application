...
<body>
	...
	<div class="container">
		<a href="BatchList"><button type="button" class="btn"
				id="b1">Back</button></a> <a href="./admin.jsp"><button
				type="button" class="btn" id="b2">Home</button></a>

		<h1>Update Batch</h1>
		<form id="passwordForm" class="form-group" name="BatchUpdate"
			method="post" action="BatchUpdate" onsubmit="return mail()">
			...
			<table class="table-responsive">
				...
				<tr>
					<td><input class="form-control brc" type="text"
						value="<%=batch.getBid()%>" name="bid" id="bid" placeholder=" "
						required readonly></td>

					<td><input class="form-control brc" type="text"
						value="<%=batch.getBatchname()%>" name="bname" id="fullname"
						placeholder="" maxlength="30" required></td>
					<td><input class="form-control brc" type="date"
						value="<%=batch.getDate()%>" name="date" id="date" placeholder=""
						maxlength="30" required></td>
					<td><select class="form-control brc" type="text" name="course"
						id="course">
							<option value="<%=batch.getCourse()%>"><%=batch.getCourse()%>
							</option>
					...
					<td><a href=><button type="submit" class="btn" id="b3">Save</button></a>
					</td>
